 /*Write a C program to implement queue operations using Ouput Restricted Deque (double 
ended queue) works.
...
int main()
{
    ...
    for(;;)
    {
        printf("1.Insert front  \t2.Delete front\t  3.Delete front  \t4.Delete rear  \t5.Display  \t6.Exit\n");
        scanf("%d",&choice);
        switch (choice)
        {
